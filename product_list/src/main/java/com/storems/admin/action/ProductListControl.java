...
//        return JSON.toJSONString(result);
    ...
    public ResultUtil findProductListBySerialno(String serialno) {
        ...
        product.setUpdateDate(product.getUpdateDate().replaceAll("/","-"));
        product.setInputDate(product.getInputDate().replaceAll("/","-"));
    ...
    public ResultUtil saveProductList(String paramString) {
        ...
        productList.setUpdateDate(param[5].replaceAll("-","/"));
        productList.setInputDate(param[6].replaceAll("-","/"));
     ...
     * @return
     */
    @RequestMapping(value = "/product_out_list.json",produces = "application/json;charset=utf-8")
    @ResponseBody
    public ResultUtil findProductOutListPage(int currPage) {
        int begin=(currPage-1)*10;
        int pageSize=10;
        Map map=new HashMap();
        map.put("curDate", ProductUtil.getCurDate());
        ...
        map.put("pageSize",pageSize);
        //获取商品列表
        List<Map> productLists =  productListService.findProductOutListPage(map);
        //获取商品总数
        int count = productListService.findCountOutProductList(ProductUtil.getCurDate());
        //处理响应结果
        Map result=new HashMap();
        result.put("data",productLists);
        result.put("resultCount",count);
...
//        return JSON.toJSONString(result);
    ...
    @ResponseBody
    public ResultUtil findProductSomeSafeListPage(int currPage) {
        int begin=(currPage-1)*10;
        int pageSize=10;
        Map map=new HashMap();
        map.put("curDate", ProductUtil.getCurDate());
        ...
        map.put("pageSize",pageSize);
        //获取商品列表
        List<Map> productLists =  productListService.findProductSomeSafeListPage(map);
        //获取商品总数
        int count = productListService.findCountSomeSafeProductList(ProductUtil.getCurDate());
        //处理响应结果
        Map result=new HashMap();
        result.put("data",productLists);
        result.put("resultCount",count);
...
//        return JSON.toJSONString(result);
     ...
     * @return
     */
    @RequestMapping(value = "/product_unsafe_list.json",produces = "application/json;charset=utf-8")
    @ResponseBody
    public ResultUtil findProductUnsafeListPage(int currPage) {
        int begin=(currPage-1)*10;
        int pageSize=10;
        Map map=new HashMap();
        map.put("curDate", ProductUtil.getCurDate());
        ...
        map.put("pageSize",pageSize);
        //获取商品列表
        List<Map> productLists =  productListService.findProductUnsafeListPage(map);
        //获取商品总数
        int count = productListService.findCountUnsafeProductList(ProductUtil.getCurDate());
        //处理响应结果
        Map result=new HashMap();
        result.put("data",productLists);
        result.put("resultCount",count);
