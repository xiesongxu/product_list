	...
	<ul id="navigation">
		<li><a class="head">仓库管理</a>
			<ul>
				...
				<li><a href="goods/Goods_SomeSafegoodsIndex.action" target="rightFrame">临近保质期商品维护</a></li>
				<li><a href="goods/Goods_UnsafeGoodsIndex.action" target="rightFrame">过期商品维护</a></li>
				<li><a href="goods/Goods_OutGoodsIndex.action" target="rightFrame">已出库商品维护</a></li>
